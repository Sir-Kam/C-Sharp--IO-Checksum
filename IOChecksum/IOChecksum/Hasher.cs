...
namespace IOChecksum
{
    ...
    public static class Hasher
    {
        ...
        /// </remarks>
        public static byte[] HashDirectory(string algorithmName, DirectoryInfo directoryInfo)
        {
        ...
        public static byte[] HashFile(string algorithmName, FileInfo fileInfo)
        {
            using (var hashAlgorithm = HashAlgorithm.Create(algorithmName))
        ...
        /// <summary>
        /// Computes checksum-hash of specified directory.
        /// </summary>
        /// <param name="dirInfo">The directory to hash</param>
        /// <returns>Byte array of hash</returns>
        public static byte[] getDirectorySHA512(DirectoryInfo dirInfo)
        {
            return HashDirectory("SHA-512", dirInfo);
        }
